...
public class DrumKit implements MouseListener {
	...
	private Object drumLabelWithImage2;
...
String drumURL2 = "cymbal.jpg";
JLabel drumLabelWithImage2 = createLabelImage(drumURL2);
drumPanel.add(drumLabelWithImage2);
drumPanel.setLayout(new GridLayout());
drumFrame.pack();
drumLabelWithImage.addMouseListener(this);
...
else if(drumClicked.equals(drumLabelWithImage2)) {
